...
% Data=mintsCentralNodeWithGrimm;
% 
% whos
% 
% %--------------------------------------------------------------------------
...
% 
%         Mdl_Dir=[CalibrationBaseDir nodeList{inode} '/' WantedVariables{ivar} '/' ];
%         Mdl_Dir_Ver=[Mdl_Dir VersionSt '/'];
%         disp(Mdl_Dir_Ver)
%         if ~exist(Mdl_Dir_Ver,'dir')
%             mkdir(Mdl_Dir_Ver);
%         end
% 
%         fn_mat=[Mdl_Dir WantedVariables{ivar} '.mat'];
%         fn_mat_ver=[Mdl_Dir_Ver WantedVariables{ivar} '.mat'];
%         fn_data=[Mdl_Dir nodeList{inode} '_Data.mat'];
%         fn_scatter=[CalibrationBaseDir nodeList{inode} '/' WantedVariables{ivar} '/' nodeList{inode} '_scatter.png'];
%         fn_importance=[CalibrationBaseDir nodeList{inode} '/' WantedVariables{ivar} '/' nodeList{inode} '_importance.png'];
%         fn_timeseries=[CalibrationBaseDir nodeList{inode} '/' WantedVariables{ivar} '/' nodeList{inode} '_timeseries.png'];
% 
%         %--------------------------------------------------------------------------
%         disp('set up the machine learning inputs and outputs')
%         Names=RegressionVariables;
%         command=['Out=Data.' WantedVariables{ivar} ';In=['];
%         for iname=1:length(RegressionVariables)
%             command=[command 'Data.' RegressionVariables{iname} ' '];
%         end        
%         command=[command '];whos In Out'];
%         disp(command);
%         eval(command);
% 
%         %--------------------------------------------------------------------------
...
%             whos Mdl
% 
%             command=['save ' fn_mat ' Mdl RegressionVariables RegressionVariablesLabels'];
%             disp(command);
%             eval(command);
%             
%             command=['save ' fn_mat_ver ' Mdl RegressionVariables RegressionVariablesLabels'];
%             disp(command);
%             eval(command);
%             
%             command=['save ' fn_data ' In_Train Out_Train In_Validation Out_Validation In Out'];
%             disp(command);
%             eval(command);
%             
%         else
...
%         legend(...
%             '1:1',...
%             ['Training (# ' separatethousands(n_Train,',',0) ', R=' num2str(r_Train,3) ')'],...
%             ['Validation (# ' separatethousands(n_Validation,',',0) ', R=' num2str(r_Validation,3) ')'],...
%             'Location','northwest' ...
%             )

    ...
    for inode=1:length(nodeList)      
            ...
            if(~isempty(mints))
                   ...
                   for ivar=1:length(WantedVariables)
                    ...
                    printCSVDaily(calibrated,wantedOut,calibratedFolder,nodeID,givenDate,"calibrated_UTC")    
                    drawAllTimeSeriesPlots(calibrated,nodeID,givenDate,calibratedFolder,"UTC")

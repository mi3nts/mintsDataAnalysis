...
saveMintsDates(dataFolder,dotMatsFolder,nodeID,"GPSGPGGA",startDate,endDate);
saveMintsDates(dataFolder,dotMatsFolder,nodeID,"OPCN3",startDate,endDate);
saveMintsDates(dataFolder,dotMatsFolder,nodeID,"LIBRAD",startDate,endDate);
saveMintsDates(dataFolder,dotMatsFolder,nodeID,"BME280",startDate,endDate);
saveMintsDates(dataFolder,dotMatsFolder,nodeID,"MGS001",startDate,endDate);
saveMintsDates(dataFolder,dotMatsFolder,nodeID,"SCD30",startDate,endDate);
saveMintsDates(dataFolder,dotMatsFolder,nodeID,"TSL2591",startDate,endDate);
saveMintsDates(dataFolder,dotMatsFolder,nodeID,"VEML6070",startDate,endDate);
